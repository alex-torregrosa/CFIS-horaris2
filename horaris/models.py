...
class Carrera(models.Model):
    ...
    facultad = models.ForeignKey(Facultad, on_delete=models.CASCADE,default=None)
...
class Grupo(models.Model):
    ...
    assignatura = models.ForeignKey(Asignatura, on_delete=models.CASCADE,default=None)
